...
import kr.hhplus.be.server.infra.product.ranking.RedisProductSaleScoreCalculator.calculate
...
class RedisProductSaleRankingRepositoryImpl(
    ...
    override fun renewRanking(
        ...
        val unionKey = unionKey(start = startDate, end = endDate)
    ...
    override fun findTopNProductIds(
        ...
        val unionKey = unionKey(startDate, endDate)
        return fetchTopProductIds(unionKey, limit)
    }
